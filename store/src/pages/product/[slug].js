                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            ...
                            <ul className="flex mt-4">
                              <li className="flex items-center text-center border border-gray-100 rounded-full hover:bg-[#043B33]  mr-2 transition ease-in-out duration-500">
                                <FacebookShareButton
                                  url={`https://vaporvibe-store-nine.vercel.app/product/${router.query.slug}`}
                                  quote=""
                                >
