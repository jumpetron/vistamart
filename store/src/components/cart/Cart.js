      ...
      <div className="flex flex-col w-full h-full justify-between items-middle bg-white rounded cursor-pointer">
        ...
        <div className="mx-5 my-3">
          <button
            ...
            className="w-full py-3 px-3 rounded-lg bg-[#043B33] hover:bg-emerald-600 flex items-center justify-between bg-heading text-sm sm:text-base text-white focus:outline-none transition duration-300"
          >
