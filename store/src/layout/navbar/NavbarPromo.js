                  ...
                  >
                    {storeCustomizationSetting?.navbar
                      ...
                      <Popover className="relative font-serif">
                        <Popover.Button className="group inline-flex items-center py-2 hover:text-[#7fffd4] focus:outline-none">
                          ...
                          <ChevronDownIcon
                            className="ml-1 h-3 w-3 group-hover:text-[#7fffd4]"
                            aria-hidden="true"
                          />
                        </Popover.Button>
                    ...
                    {storeCustomizationSetting?.navbar?.about_menu_status && (
                      <Link
                        ...
                        className="font-serif mx-4 py-2 text-sm font-medium hover:text-[#7fffd4]"
                      >
                        {showingTranslateValue(
                    ...
                    <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 text-sm font-medium hover:text-[#7fffd4] focus:outline-none">
                        <span>
                          {showingTranslateValue(
                        ...
                        <Popover.Panel className="absolute z-10 -ml-1 mt-1 transform w-screen max-w-xs bg-white">
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-y-scroll flex-grow scrollbar-hide w-full h-full">
                            <div className="relative grid gap-2 px-6 py-6">
                              {storeCustomizationSetting?.navbar
                                ?.offers_menu_status && (
                                <span className="p-2  font-serif items-center rounded-md hover:bg-gray-50 w-full hover:text-[#7fffd4]">
                                  <div className="w-full flex">
                                    <FiGift className="my-auto" />
                                    <Link
                                      href="/offer"
                                      onClick={() => setIsLoading(!isLoading)}
                                      className="relative inline-flex items-center font-serif ml-2 py-0 rounded text-sm font-medium  hover:text-[#7fffd4]"
                                    >
                                      {showingTranslateValue(
                                        storeCustomizationSetting?.navbar
                                          ?.offers
                    ...
                    {storeCustomizationSetting?.navbar?.offers_menu_status && (
                      <Link
                        href="/offer"
                        onClick={() => setIsLoading(!isLoading)}
                        className="relative inline-flex items-center  bg-red-100 font-serif ml-4 py-0 px-2 rounded text-sm font-medium text-red-500 hover:text-[#7fffd4]"
                      >
                        {showingTranslateValue(
