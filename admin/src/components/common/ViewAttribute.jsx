  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="absolute bottom-0 right-0 focus:outline-none active:outline-none text-sm py-1 px-2 rounded-sm bg-[#043B33] text-gray-100 hover:bg-emerald-600"
          >
            View
          </Link>
        </div>
      ...
      <div
        ...
        className="flex justify-center text-center cursor-pointer text-gray-400 hover:text-[#7fffd4]"
      >
        {" "}
        <Tooltip
          id="view"
